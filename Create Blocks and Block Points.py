...
for name in ["San Antonio"]:
    ...
    reference_data = "'Z:\Users\Matt\SanAntonio\GIS\Grids\SanAntonio_1930_GridToGeocode.shp' 'Primary Table'"
    grid = "Z:\Users\Matt\SanAntonio\GIS\Grids\SanAntonio_1930_GridToGeocode.shp"
    dissolve_grid = "Z:\Users\Matt\SanAntonio\GIS\Process Files\PostGridEdit_Dissolve.shp"
    split_grid = "Z:\Users\Matt\SanAntonio\GIS\Process Files\PostGridEdit_Split.shp"
    pblocks = "Z:\Users\Matt\SanAntonio\GIS\Process Files\PostGridEdit_Pblocks30.shp"
    in_field_map='''
    "'Feature ID' <None> VISIBLE NONE;'*From Left' lfromadd VISIBLE NONE;'*To Left' LTOADD VISIBLE NONE;'*From Right' RFROMADD VISIBLE NONE;
    ...
    'Suffix Type' <None> VISIBLE NONE;'Suffix Direction' <None> VISIBLE NONE;'Left City or Place' CITY VISIBLE NONE;
    'Right City or Place' CITY VISIBLE NONE;'Left ZIP Code' <None> VISIBLE NONE;'Right ZIP Code' <None> VISIBLE NONE;'Left State' STATE VISIBLE NONE;
    'Right State' STATE VISIBLE NONE;'Left Street ID' <None> VISIBLE NONE;'Right Street ID' <None> VISIBLE NONE;'Display X' <None> VISIBLE NONE;
    'Display Y' <None> VISIBLE NONE;'Min X value for extent' <None> VISIBLE NONE;'Max X value for extent' <None> VISIBLE NONE;
    'Min Y value for extent' <None> VISIBLE NONE;'Max Y value for extent' <None> VISIBLE NONE;'Left parity' <None> VISIBLE NONE;
    'Right parity' <None> VISIBLE NONE;'Left Additional Field' <None> VISIBLE NONE;'Right Additional Field' <None> VISIBLE NONE;
    'Altname JoinID' <None> VISIBLE NONE;'''
    add_locator = "Z:\Users\Matt\SanAntonio\GIS\Process Files\PostEdit_addloc"
    #'Add_30' originates from 'Create 1930 and 1940 Address Files.R' code
    addresses = "Z:\Users\Matt\SanAntonio\GIS\Geocoded Points\Add_PostEdit_30.csv"
    address_fields="Street address;City city;State state"
    points30 = "Z:\Users\Matt\SanAntonio\GIS\Geocoded Points\SanAntonio_Points30_PostEdit.shp"
    pblk_points = "Z:\Users\Matt\SanAntonio\GIS\Geocoded Points\SA_1930_PostEdit_Pblk_Points.shp"
    ...
    arcpy.Delete_management(dissolve_grid)
    arcpy.Delete_management(split_grid)
