...
for name in ["San Antonio"]:
    ...
    reference_data = "'Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_1930_stgrid_edit.shp' 'Primary Table'"
    grid = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_1930_stgrid_edit.shp"
    dissolve_grid = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_1930_stgrid_Dissolve_2.shp"
    split_grid = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_1930_stgrid_Split_2.shp"
    pblocks = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_1930_Pblk_2.shp"
    in_field_map='''
    ...
    add_locator = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_addloc_2"
    #'Add_30_2nd' originates from 'Create 1930 and 1940 Address Files_2nd.R' code
    addresses = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\Add_30_2nd.csv"
    address_fields="Street address;City city;State state"
    points30 = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_Points30_2.shp"
    pblk_points = "Z:\Projects\\1940Census\Block Creation\\" + name + "\\" + name + "_1930_Pblk_Points_2.shp"
